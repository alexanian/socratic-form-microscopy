...
Now, you might believe that these problems aren't very serious, or that surely people making a decision as big as a college major or career would correct for them. But these fallacies date to the <em>70s</em>! Many people still haven't heard of them. And the studies that first identified them found them to be pretty much universal. Look, the CIA <a href="https://www.theguardian.com/news/datablog/2015/aug/14/how-probable-is-probable">couldn't even get people to do probability right</a>. You think the average job seeker can? You think you can? <a href="{{ site.baseurl }}/2018/01/03/2018-predictions/">Make a bunch of predictions for the next year</a> and then talk with me when you know how calibrated (or uncalibrated) you are.
